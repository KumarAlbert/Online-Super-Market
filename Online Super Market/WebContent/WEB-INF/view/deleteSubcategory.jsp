...
<div class="panel">
  <h2>Delete Subcategory</h2>
	<form onsubmit="return validation()"method="POST" action="subcategoryDelete.html">
  		 <div class="form-group">
    		<label >Enter Subcategory Name</label>
    		<input name="name" type="text" class="form-control" required="required" placeholder="Enter sub Category name" id="name"/>
  		</div>
